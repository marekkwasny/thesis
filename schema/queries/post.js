...
export const Posts = {
    ...
    resolve: async (_, args, ctx) => {
        return await db.fetchPosts(ctx.pool, parseInt(args.user), args.limit, args.cursor);
    },
};
...
export const Posts1 = {
    ...
    resolve: async (_, args, ctx) => {
        ...
        return await qs.fetchPosts(ctx.pool, parseInt(args.user), args.limit, args.cursor);
    },
};
