...
//Komponent wczytujący posty dla widoku CQRS 3.
            ...
            <center>
                {data.postsThree.posts.map((x, i) => (
                    <React.Fragment key={`${i}-${user}-${x.id}-3`}>
                        ...
                        {data.postsThree.hasMore &&
                            i === data.postsThree.posts.length - 5 && (
                                <Waypoint
                                    onEnter={() => {
                                        fetchMore({
                                            variables: {
                                                ...
                                                limit: 5,
                                                cursor: parseInt(
                                                    data.postsThree.posts[
                                                        data.postsThree.posts.length - 1
                                                    ].id
                                                ),
                                            },
